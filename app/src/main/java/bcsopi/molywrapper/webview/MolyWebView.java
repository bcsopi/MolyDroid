...
public class MolyWebView extends WebView {
    ...
    private MolyWebViewClient mWebViewClient = null;
    private MolyWebChromeClient mWebChromeClient = null;
     ...
     */
    public MolyWebView(Context context) {
        this(context, null);
    }
     ...
     */
    public MolyWebView(Context context, AttributeSet attrs) {
     ...
     */
    public MolyWebView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initializeWebView() {
        ...
        mWebViewClient = new MolyWebViewClient();
        setWebViewClient(mWebViewClient);

        // New instance of FutebolWebChromeClient and keep a reference to it
        mWebChromeClient = new MolyWebChromeClient(mContext);
     ...
     *
     * @param listener {@link MolyWebChromeClient.WebChromeClientListener}. It must be
     *                 in the Activity context.
     */
    public void setWebChromeClientListener(MolyWebChromeClient.WebChromeClientListener listener) {
        if (!mInitialized || (mWebChromeClient == null)) {
            throw new IllegalStateException("The WebView must be initialized first.");
        }
     ...
     *
     * @param listener {@link MolyWebViewClient.WebViewClientListener}. It must be
     *                 in the Activity context.
     */
    public void setWebViewClientListener(MolyWebViewClient.WebViewClientListener listener) {
